...
class _MoneyReceiptListScreenState extends State<MoneyReceiptForm> {
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(child:  ResponsiveRow(
      spacing: 0,
      runSpacing: 0,
      children: [
        if (isBigScreen)
                  ...
                  children: [
                    ResponsiveRow(
                      ...
                      children: [
                        ...
                        selectedPaymentToState.value != "Specific"
                            ? SizedBox.shrink():   ResponsiveCol(
                          xs: 12,
                          sm: 3,
                          md: 3,
                          lg: 3,
                            ...
                            builder: (context, selectedPaymentTo, child) {
                              return selectedPaymentTo == "Specific"
                                ...
                                builder: (context, selectedPosSale, child) {
                                  return BlocBuilder<PosSaleBloc,
                                      PosSaleState>(
                                    builder: (context, state) {
                                      final posSaleBloc =
                                      ...
                                      return AppDropdown<PosSaleModel>(
                                        ...
                                        onChanged: (newVal) {
                                          ...
                                          if (newVal != null) {
                                            moneyBloc.amountController.text =
                                                newVal.dueAmount.toString();
                                          }
                                          setState(() {});
                                        },
                                        validator: (value) {
