...
class MobileMoneyReceiptList extends StatefulWidget {
  const MobileMoneyReceiptList({super.key});

  @override
  State<MobileMoneyReceiptList> createState() => _MoneyReceiptScreenState();
}

class _MoneyReceiptScreenState extends State<MobileMoneyReceiptList> {
