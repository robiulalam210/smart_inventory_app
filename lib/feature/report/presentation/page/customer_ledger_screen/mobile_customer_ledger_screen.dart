// Updated: 2026-01-14 — fixes for compile errors (Color.withOpacity), consistent currency formatting,
// PDF background, minor UI tweaks for Clear button, and correct balance color logic.
...
class MobileCustomerLedgerScreen extends StatefulWidget {
  ...
  @override
  State<MobileCustomerLedgerScreen> createState() => _CustomerLedgerScreenState();
}

class _CustomerLedgerScreenState extends State<MobileCustomerLedgerScreen> {
  DateRange? selectedDateRange;

  @override
  void initState() {
    super.initState();
    // keep event shape as-is to avoid breaking external contract
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 8,
                children: [
                  _buildSummaryItem("Opening Balance", _formatCurrency(openingBalance), Icons.account_balance_wallet, Colors.blue),
                  _buildSummaryItem(
                    "Closing Balance",
                  ...
                  _buildSummaryItem("Total Debit", _formatCurrency(totalDebit), Icons.arrow_downward, Colors.red),
                  _buildSummaryItem("Total Credit", _formatCurrency(totalCredit), Icons.arrow_upward, Colors.green),
          ...
          BlocBuilder<CustomerLedgerBloc, CustomerLedgerState>(
            builder: (context, state) {
              ...
              return ElevatedButton(
                onPressed: customer != null ? () => _fetchCustomerLedger(customer: customer.id.toString()) : null,
                      ...
                      child: ConstrainedBox(
                        ...
                        child: DataTable(
                          ...
                          rows: transactions.asMap().entries.map((entry) {
                            ...
                            return DataRow(
                              onSelectChanged: onTransactionTap != null ? (_) => onTransactionTap!() : null,
                              cells: [
