...
//
//     final salesReturnCreatedModel = salesReturnCreatedModelFromJson(jsonString);

import 'dart:convert';

SalesReturnCreatedModel salesReturnCreatedModelFromJson(String str) => SalesReturnCreatedModel.fromJson(json.decode(str));

String salesReturnCreatedModelToJson(SalesReturnCreatedModel data) => json.encode(data.toJson());

class SalesReturnCreatedModel {
  final bool? status;
  final String? message;
  final Data? data;

  SalesReturnCreatedModel({
    this.status,
    this.message,
    this.data,
  });

  factory SalesReturnCreatedModel.fromJson(Map<String, dynamic> json) => SalesReturnCreatedModel(
    status: json["status"],
