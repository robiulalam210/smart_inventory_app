...
//                       onPressed: () => _showEditDialog(context, mode,productId),
//                     ),
//                     IconButton(
...
//   }
//
//   void _showEditDialog(BuildContext context, ProductSaleModeModel mode,productId) {
//
//     print("mode${mode.toJson()}");
//
//     showDialog(
//       context: context,
//       builder: (context) {
