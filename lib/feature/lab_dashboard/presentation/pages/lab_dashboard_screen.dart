                    ...
                    child: Column(
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            ToggleButtons(
                              ...
                              isSelected: List.generate(labels.length, (index) => selectedIndex == index),
                        ...
                        Wrap(
                          ...
                          runSpacing: 10,
                          children: [
                            dashboardCardItem(title: "Total Amount", value: 55, icon: Icons.attach_money, color: Colors.orange, isCurrency: true),
                            dashboardCardItem(title: "Total Patient", value: 0, icon: Icons.people, color: Colors.blue),
                            dashboardCardItem(title: "Discount", value: 4, icon: Icons.attach_money, color: Colors.green, isCurrency: true),
                            dashboardCardItem(title: "Total Due", value: 4, icon: Icons.money_off, color: Colors.green, isCurrency: true),
                            dashboardCardItem(title: "Net Amount", value: 4, icon: Icons.payments, color: Colors.orange, isCurrency: true),
                          ],
                        ),
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: CupertinoSegmentedControl<String>(
                                      ...
                                      children: {
                                        'current_day': Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontFamily: GoogleFonts.playfairDisplay().fontFamily,
                                              color: selectedSalesOverviewType == 'current_day' ? Colors.white : Colors.black,
                                            ),
                                          ),
                                        ),
                                        'this_month': Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontFamily: GoogleFonts.playfairDisplay().fontFamily,
                                              color: selectedSalesOverviewType == 'this_month' ? Colors.white : Colors.black,
                                            ),
                                          ),
                                        ),
                                        'lifeTime': Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontFamily: GoogleFonts.playfairDisplay().fontFamily,
                                              color: selectedSalesOverviewType == 'lifeTime' ? Colors.white : Colors.black,
                                            ),
                                          ),
                                        ),
                                      },
                                      ...
                                      groupValue: selectedSalesOverviewType,
                                      ...
                                      children: {
                                        'current_day': Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontFamily: GoogleFonts.playfairDisplay().fontFamily,
                                              color: selectedPurchaseOverviewType == 'current_day' ? Colors.white : Colors.black,
                                            ),
                                          ),
                                        ),
                                        'this_month': Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontFamily: GoogleFonts.playfairDisplay().fontFamily,
                                              color: selectedPurchaseOverviewType == 'this_month' ? Colors.white : Colors.black,
                                            ),
                                          ),
                                        ),
                                        'lifeTime': Padding(
                                          ...
                                          child: Text(
                                            ...
                                            style: TextStyle(
                                              fontFamily: GoogleFonts.playfairDisplay().fontFamily,
                                              color: selectedPurchaseOverviewType == 'lifeTime' ? Colors.white : Colors.black,
                                            ),
                                          ),
                                        ),
                                      },
                            ...
                            child: Column(
                              children: [
                                ...
                                Expanded(
                                  child: TabBarView(
                                    children: [
                                      SingleChildScrollView(child: topSelling(context, [])), //state.dashboard.topProduct ?? []
                                      SingleChildScrollView(child: lowStock(context, [])), //state.dashboard.lowStockProducts ?? []
                                      SingleChildScrollView(child: customer(context, itemName: "Customers",  lowStockProducts: [])), //state.dashboard.topClients ?? []
                                      SingleChildScrollView(child: customer(context, itemName: "Supplier", lowStockProducts: [])), //state.dashboard.topSuppliers ?? []
                                      Padding(
                                        padding: const EdgeInsets.all(16.0),
                                        child: ListView.builder(
                                          shrinkWrap: true,
                                          physics: const NeverScrollableScrollPhysics(),
                                          itemCount: 0, //state.dashboard.accounts?.length ?? 0,
                                          itemBuilder: (_, index) {
                      ...
                      children: [
                        Container(
                          ...
                          child: Image.asset(
                            ...
                            color: Colors.white,
                            width:
                            Responsive.isMobile(context)?35:50, // Replace with your AppColors.whiteColor if defined
                          ),
                        ),
                        const SizedBox(width: 3),
                        SizedBox(
                          width: AppSizes.width(context) * 0.28,
                          child: Text(
                            count.toString(),
                            maxLines: 2,
                            style: TextStyle(
